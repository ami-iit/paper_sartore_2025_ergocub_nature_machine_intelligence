...
class Optimizer:
    def __init__(
        ...
        self.consider_original = consider_original
    ...
    def initialize_parameter_search_variable(self):
        ...
        if(self.consider_original):
            self.lengths_multipliers = self.solver.parameter(self.numberOfParameter)
    ...
    def compute_original_density(self):
        ...
        for item in self.minimum_set_parameters_links:
            ...
            print(item, eCubUtils.ComputeOriginalDensity(self.kinDyn, item))
            dict_densities.update({item:eCubUtils.ComputeOriginalDensity(self.kinDyn, item)})
        self.density_vector = ergoCubConfiguration.CreateTotalHardwareParameterVector(
            self.partsList, density_vector_min
        )
        print(dict_densities)
    ...
    def modify_urdf(self, urdf_path_modified):
        ...
        print(self.length_optimum_vector)
        print(self.density_optimum_vector)
