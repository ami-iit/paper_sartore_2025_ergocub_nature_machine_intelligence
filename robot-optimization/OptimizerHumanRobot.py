...
class OptimizerHumanRobot:
    ...
    def minimum_torque_cost(self):
        ...
        for i in range(self.number_of_points):
            ...
            value_constraint = 0.4
            # self.solver.subject_to(s_i_robot[0]<value_constraint)
            # self.solver.subject_to(s_i_robot[1]<value_constraint)
            # self.solver.subject_to(s_i_robot[2]<value_constraint)
